...
export default {
    ...
    data () {
        return {
          ...
          //部门抽奖项目 
          depList: [
            {"cardid":"","name":"","dep":"爱学习在线中心"},
            {"cardid":"","name":"","dep":"爱学习咨询中心"},
            {"cardid":"","name":"","dep":"爱学习双师中心"},
            {"cardid":"","name":"","dep":"爱学习学科中心"},
            {"cardid":"","name":"","dep":"爱学习技术中心"},
            {"cardid":"","name":"","dep":"爱学习产品中心"},
            {"cardid":"","name":"","dep":"爱学习运营中心"},
            {"cardid":"","name":"","dep":"爱学习商业分析部"},
            {"cardid":"","name":"","dep":"爱学习企管部"},
            {"cardid":"","name":"","dep":"集团产品中心"},
            {"cardid":"","name":"","dep":"集团技术中心"}
          ],
          aixuexi_teachList: [],
          depNow: '爱学习产品中心', // 替换部门
        }
    ...
    methods: {
        foundParam() {
          return this.newHerosList              //抽所有人
          // return this.depList              //抽部门
          // return this.aixuexi_teachList       //抽部门员工（ 更改depNow ）
        },
        receiveParam(rs) {
          return this.heroRoll = rs.data.calledHeros || []   //所有人抽奖
          // return this.heroRoll = this.heroRoll  // 部门 或 部门员工
        },
         ...
         * （点击按钮）
         */
        startSummon(num) {//num 是控制台传过来的抽奖人数
            ...
            let result = MagicCircle.call(this.foundParam(), num)
    ...
    mounted() {
        this.$nextTick(() => {
            $.ajax({
              ...
              this.traverseNewHeroList(this.newHerosList, this.heroRoll)
